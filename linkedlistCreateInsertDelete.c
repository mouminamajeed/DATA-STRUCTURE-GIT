...
void create()
{
 ...
 void insertmid()
 {
 	...
 	printf("\n enter the num of element to be inserted:-");
	scanf("%d",&ptr->data);
 ...
 void insertbeg()
 {
 	struct node *ptr;
	ptr=(struct node *)malloc(sizeof(struct node));
	printf("\n enter elemnt  which u want to insert at the beginning:-");
	scanf("%d",&ptr->data);
	ptr->next=head;
	head=ptr;
 }
 ...
 void insertend()
 {
 	struct node *ptr,*cpt;
	ptr=(struct node *)malloc(sizeof(struct node));
	printf("\n enter the elemnt which u want to insrt at the end of node:- ");
	scanf("%d",&ptr->data);
	cpt=head;
	while(cpt->next!=NULL)
      {
  ...
  void delete()
  {
  	struct node *ptr,*cpt;
  	int item;
  	printf("enter the elemnt which u wantto be deleted:-");
  	scanf("%d",&item);
